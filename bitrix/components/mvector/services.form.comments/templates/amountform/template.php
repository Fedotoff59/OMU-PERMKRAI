...
<?      for($i = 0; $i < count($arResult); $i++) { ?>
            <div style="margin-bottom: 5px; margin-top: 15px;  width: 660px; min-height: 100px; background: #fec">
        ...
        <? if($arResult[$i]['COMMENTANSWER'] != '') { ?>
            ...
            <div style="margin-bottom: 5px; margin-top: 15px; margin-left: 25px;  width: 635px; min-height: 100px; background: #fcc">
